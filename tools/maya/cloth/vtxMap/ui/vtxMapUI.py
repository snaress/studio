...
#
# Created: Sun Jan 25 20:37:54 2015
...
class Ui_mwVtxMap(object):
    def setupUi(self, mwVtxMap):
        ...
        self.hlVtxSelRange.addWidget(self.lRangeMin)
        ...
        self.hlVtxSelRange.addWidget(self.lRangeMax)
        ...
        self.horizontalLayout.addWidget(self.pbVtxSelect)
        ...
        self.horizontalLayout.addWidget(self.pbVtxClear)
        self.vlVtxEdition.addLayout(self.horizontalLayout)
    ...
    def retranslateUi(self, mwVtxMap):
        ...
        self.lRangeMin.setText(_translate("mwVtxMap", "Min=", None))
        self.lRangeMax.setText(_translate("mwVtxMap", "Max=", None))
        self.pbVtxSelect.setText(_translate("mwVtxMap", "Select", None))
        self.pbVtxClear.setText(_translate("mwVtxMap", "Clear", None))
