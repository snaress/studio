...
#
# Created: Sat Dec 19 00:34:35 2015
...
class Ui_wg_treeWidget(object):
    def setupUi(self, wg_treeWidget):
        wg_treeWidget.setObjectName(_fromUtf8("wg_treeWidget"))
        wg_treeWidget.resize(510, 419)
        self.gridLayout = QtGui.QGridLayout(wg_treeWidget)
        self.gridLayout.setObjectName(_fromUtf8("gridLayout"))
        self.qf_apply = QtGui.QFrame(wg_treeWidget)
        ...
        self.line_16 = QtGui.QFrame(self.qf_apply)
        ...
        self.hl_apply.addWidget(self.line_16)
        ...
        self.hl_apply.addWidget(self.line_17)
        ...
        self.line_18 = QtGui.QFrame(self.qf_apply)
        ...
        self.qf_treeEdit_L = QtGui.QFrame(wg_treeWidget)
        ...
        self.line_13 = QtGui.QFrame(self.qf_moveItem)
        ...
        self.hl_moveItem.addWidget(self.line_13)
        ...
        self.hl_moveItem.addWidget(self.line_14)
        ...
        self.hl_moveItem.addWidget(self.line_15)
        ...
        self.line_5 = QtGui.QFrame(wg_treeWidget)
        self.line_5.setFrameShape(QtGui.QFrame.VLine)
        self.line_5.setFrameShadow(QtGui.QFrame.Sunken)
        self.line_5.setObjectName(_fromUtf8("line_5"))
        self.hl_tree.addWidget(self.line_5)
        self.tw_tree = QtGui.QTreeWidget(wg_treeWidget)
        ...
        self.line_6 = QtGui.QFrame(wg_treeWidget)
        self.line_6.setFrameShape(QtGui.QFrame.VLine)
        self.line_6.setFrameShadow(QtGui.QFrame.Sunken)
        self.line_6.setObjectName(_fromUtf8("line_6"))
        self.hl_tree.addWidget(self.line_6)
        self.qf_treeEdit_R = QtGui.QFrame(wg_treeWidget)
    ...
    def retranslateUi(self, wg_treeWidget):
        ...
        self.pb_apply.setText(_translate("wg_treeWidget", "Apply", None))
        self.pb_cancel.setText(_translate("wg_treeWidget", "Cancel", None))
        self.pb_add.setText(_translate("wg_treeWidget", "Add", None))
        self.pb_del.setText(_translate("wg_treeWidget", "Del", None))
        self.pb_edit1.setText(_translate("wg_treeWidget", "Edit_1", None))
        self.pb_edit2.setText(_translate("wg_treeWidget", "Edit_2", None))
        self.l_title.setText(_translate("wg_treeWidget", "Title", None))
