...
#
# Created: Mon Oct 19 20:21:50 2015
...
class Ui_wgLoop(object):
    def setupUi(self, wgLoop):
        ...
        self.gridLayout.addWidget(self.qfLoopRange, 6, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.qfLoopSingle, 8, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.qfLoopList, 7, 0, 1, 1)
        ...
        self.hlLoopOption.addItem(spacerItem4)
        ...
        self.gridLayout.addLayout(self.hlLoopOption, 4, 0, 1, 1)
        ...
        self.hlLoopMode.addItem(spacerItem6)
        ...
        self.hfRemoteOptions = QtGui.QFrame(wgLoop)
        self.hfRemoteOptions.setFrameShape(QtGui.QFrame.StyledPanel)
        self.hfRemoteOptions.setObjectName(_fromUtf8("hfRemoteOptions"))
        self.hlRemoteOptions = QtGui.QHBoxLayout(self.hfRemoteOptions)
        self.hlRemoteOptions.setSpacing(2)
        self.hlRemoteOptions.setContentsMargins(4, 0, 4, 0)
        self.hlRemoteOptions.setObjectName(_fromUtf8("hlRemoteOptions"))
        self.lPacket = QtGui.QLabel(self.hfRemoteOptions)
        self.lPacket.setObjectName(_fromUtf8("lPacket"))
        self.hlRemoteOptions.addWidget(self.lPacket)
        self.sbPacket = QtGui.QSpinBox(self.hfRemoteOptions)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.MinimumExpanding, QtGui.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.sbPacket.sizePolicy().hasHeightForWidth())
        self.sbPacket.setSizePolicy(sizePolicy)
        self.sbPacket.setMinimumSize(QtCore.QSize(50, 0))
        self.sbPacket.setMaximumSize(QtCore.QSize(50, 16777215))
        self.sbPacket.setAlignment(QtCore.Qt.AlignCenter)
        self.sbPacket.setButtonSymbols(QtGui.QAbstractSpinBox.NoButtons)
        self.sbPacket.setObjectName(_fromUtf8("sbPacket"))
        self.hlRemoteOptions.addWidget(self.sbPacket)
        spacerItem7 = QtGui.QSpacerItem(40, 20, QtGui.QSizePolicy.Expanding, QtGui.QSizePolicy.Minimum)
        self.hlRemoteOptions.addItem(spacerItem7)
        self.lPool = QtGui.QLabel(self.hfRemoteOptions)
        self.lPool.setObjectName(_fromUtf8("lPool"))
        self.hlRemoteOptions.addWidget(self.lPool)
        self.lePool = QtGui.QLineEdit(self.hfRemoteOptions)
        self.lePool.setObjectName(_fromUtf8("lePool"))
        self.hlRemoteOptions.addWidget(self.lePool)
        self.gridLayout.addWidget(self.hfRemoteOptions, 2, 0, 1, 1)
    ...
    def retranslateUi(self, wgLoop):
        ...
        self.lPacket.setText(_translate("wgLoop", "Packet: ", None))
        self.lPool.setText(_translate("wgLoop", "Pool: ", None))
        self.lePool.setText(_translate("wgLoop", "default", None))
