...
#
# Created: Thu Oct 29 16:42:21 2015
...
class Ui_mwGrapher(object):
    def setupUi(self, mwGrapher):
        ...
        self.menuBank = QtGui.QMenu(self.menubar)
        self.menuBank.setObjectName(_fromUtf8("menuBank"))
        self.menuNodes = QtGui.QMenu(self.menuBank)
        self.menuNodes.setObjectName(_fromUtf8("menuNodes"))
        self.menuStudioNodes = QtGui.QMenu(self.menuNodes)
        self.menuStudioNodes.setObjectName(_fromUtf8("menuStudioNodes"))
        self.menuProdsNodes = QtGui.QMenu(self.menuNodes)
        self.menuProdsNodes.setObjectName(_fromUtf8("menuProdsNodes"))
        self.menuUsersNodes = QtGui.QMenu(self.menuNodes)
        self.menuUsersNodes.setObjectName(_fromUtf8("menuUsersNodes"))
        self.menuScripts = QtGui.QMenu(self.menuBank)
        self.menuScripts.setObjectName(_fromUtf8("menuScripts"))
        self.menuStudioScripts = QtGui.QMenu(self.menuScripts)
        self.menuStudioScripts.setObjectName(_fromUtf8("menuStudioScripts"))
        self.menuProdsScripts = QtGui.QMenu(self.menuScripts)
        self.menuProdsScripts.setObjectName(_fromUtf8("menuProdsScripts"))
        self.menuUsersScripts = QtGui.QMenu(self.menuScripts)
        self.menuUsersScripts.setObjectName(_fromUtf8("menuUsersScripts"))
        ...
        self.actionDede = QtGui.QAction(mwGrapher)
        self.actionDede.setObjectName(_fromUtf8("actionDede"))
        self.actionDede_2 = QtGui.QAction(mwGrapher)
        self.actionDede_2.setObjectName(_fromUtf8("actionDede_2"))
        self.actionDede_3 = QtGui.QAction(mwGrapher)
        self.actionDede_3.setObjectName(_fromUtf8("actionDede_3"))
        self.actionDede_4 = QtGui.QAction(mwGrapher)
        self.actionDede_4.setObjectName(_fromUtf8("actionDede_4"))
        self.actionDede_5 = QtGui.QAction(mwGrapher)
        self.actionDede_5.setObjectName(_fromUtf8("actionDede_5"))
        self.actionDede_6 = QtGui.QAction(mwGrapher)
        self.actionDede_6.setObjectName(_fromUtf8("actionDede_6"))
        ...
        self.menuNodes.addAction(self.menuStudioNodes.menuAction())
        self.menuNodes.addAction(self.menuProdsNodes.menuAction())
        self.menuNodes.addAction(self.menuUsersNodes.menuAction())
        self.menuScripts.addAction(self.menuStudioScripts.menuAction())
        self.menuScripts.addAction(self.menuProdsScripts.menuAction())
        self.menuScripts.addAction(self.menuUsersScripts.menuAction())
        self.menuBank.addAction(self.menuNodes.menuAction())
        self.menuBank.addAction(self.menuScripts.menuAction())
    ...
    def retranslateUi(self, mwGrapher):
        ...
        self.menuBank.setTitle(_translate("mwGrapher", "Bank", None))
        self.menuNodes.setTitle(_translate("mwGrapher", "Nodes", None))
        self.menuStudioNodes.setTitle(_translate("mwGrapher", "Studio", None))
        self.menuProdsNodes.setTitle(_translate("mwGrapher", "Prods", None))
        self.menuUsersNodes.setTitle(_translate("mwGrapher", "Users", None))
        self.menuScripts.setTitle(_translate("mwGrapher", "Scripts", None))
        self.menuStudioScripts.setTitle(_translate("mwGrapher", "Studio", None))
        self.menuProdsScripts.setTitle(_translate("mwGrapher", "Prods", None))
        self.menuUsersScripts.setTitle(_translate("mwGrapher", "Users", None))
        ...
        self.actionDede.setText(_translate("mwGrapher", "dede", None))
        self.actionDede_2.setText(_translate("mwGrapher", "dede", None))
        self.actionDede_3.setText(_translate("mwGrapher", "dede", None))
        self.actionDede_4.setText(_translate("mwGrapher", "dede", None))
        self.actionDede_5.setText(_translate("mwGrapher", "dede", None))
        self.actionDede_6.setText(_translate("mwGrapher", "dede", None))
