...
#
# Created: Mon Dec 08 17:45:11 2014
...
class Ui_transfert(object):
    def setupUi(self, transfert):
        ...
        self.gridLayout.addLayout(self.hlTmpFolder, 5, 0, 1, 1)
        ...
        self.gridLayout.addLayout(self.hlBtns, 7, 0, 1, 1)
        self.qfDestination2 = QtGui.QFrame(transfert)
        self.qfDestination2.setObjectName(_fromUtf8("qfDestination2"))
        self.hlDestination2 = QtGui.QHBoxLayout(self.qfDestination2)
        self.hlDestination2.setSpacing(2)
        self.hlDestination2.setContentsMargins(2, 0, 2, 0)
        self.hlDestination2.setObjectName(_fromUtf8("hlDestination2"))
        self.lDestination2 = QtGui.QLabel(self.qfDestination2)
        self.lDestination2.setObjectName(_fromUtf8("lDestination2"))
        self.hlDestination2.addWidget(self.lDestination2)
        self.leDestination2 = QtGui.QLineEdit(self.qfDestination2)
        self.leDestination2.setObjectName(_fromUtf8("leDestination2"))
        self.hlDestination2.addWidget(self.leDestination2)
        self.bOpen2 = QtGui.QPushButton(self.qfDestination2)
        self.bOpen2.setObjectName(_fromUtf8("bOpen2"))
        self.hlDestination2.addWidget(self.bOpen2)
        self.gridLayout.addWidget(self.qfDestination2, 3, 0, 1, 1)
    ...
    def retranslateUi(self, transfert):
        ...
        self.lDestination2.setText(_translate("transfert", "Destination2: ", None))
        self.bOpen2.setText(_translate("transfert", "Open", None))
