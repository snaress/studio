...
#
# Created: Tue Dec 02 14:53:28 2014
...
class Ui_factory(object):
    def setupUi(self, factory):
        ...
        self.qfInfo.setMaximumSize(QtCore.QSize(16777215, 16777215))
        ...
        self.tabWidget = QtGui.QTabWidget(self.qfInfo)
        self.tabWidget.setObjectName(_fromUtf8("tabWidget"))
        self.tabInfo = QtGui.QWidget()
        self.tabInfo.setObjectName(_fromUtf8("tabInfo"))
        self.glInfo = QtGui.QGridLayout(self.tabInfo)
        self.glInfo.setMargin(0)
        self.glInfo.setSpacing(0)
        self.glInfo.setObjectName(_fromUtf8("glInfo"))
        self.teInfo = QtGui.QTextEdit(self.tabInfo)
        self.teInfo.setMaximumSize(QtCore.QSize(16777215, 16777215))
        self.teInfo.setObjectName(_fromUtf8("teInfo"))
        self.glInfo.addWidget(self.teInfo, 0, 0, 1, 1)
        self.tabWidget.addTab(self.tabInfo, _fromUtf8(""))
        self.tabShader = QtGui.QWidget()
        self.tabShader.setEnabled(True)
        self.tabShader.setObjectName(_fromUtf8("tabShader"))
        self.glShader = QtGui.QGridLayout(self.tabShader)
        self.glShader.setMargin(0)
        self.glShader.setSpacing(0)
        self.glShader.setObjectName(_fromUtf8("glShader"))
        self.tabWidget.addTab(self.tabShader, _fromUtf8(""))
    ...
    def retranslateUi(self, factory):
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tabInfo), _translate("factory", "Info", None))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tabShader), _translate("factory", "Shader", None))
